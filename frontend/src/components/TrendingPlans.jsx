...
const planData = {
  ...
  'Elevation': [
    { image: '/images/Elevation/RB.jpg', title: 'Modern Facade', type: 'Elevation', area: '2,800 sq ft', price: '₹2,200' }
  ],
  '3D-Plans': [
  ...
  '2D-Plans': [
    ...
    { image: '/images/Plans/Free Photo _ View of 3d house model.jpeg', title: 'House Model View', type: '2D Plans', area: '2,800 sq ft', price: '₹1,599' }
  ]
};
