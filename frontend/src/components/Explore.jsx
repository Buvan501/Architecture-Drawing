...
const Explore = () => {
  ...
  { type: '3d', title: '3D Plans', description: 'Photorealistic 3D renders and visualizations', image: encodeURI('/images/3D-Plans/Hotel project.jpg'), route: '/plans/3d' },
  { type: 'elevation', title: 'Elevation', description: 'Stunning facade designs and architectural elevations', image: encodeURI('/images/Elevation/Hotel project.jpg'), route: '/plans/elevation' },
  ...
  { type: 'vr', title: 'VR Experiences', description: 'Immersive virtual reality architectural experiences', image: encodeURI('/images/3D-Plans/Residential Building jpg 1.jpg'), route: '/vr-experience' }
  ];
